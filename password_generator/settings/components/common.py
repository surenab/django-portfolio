...
from password_generator.settings.components import BASE_DIR, config
...
MIDDLEWARE: Tuple[str, ...] = (
    # Logging:
    'password_generator.settings.components.logging.LoggingContextVarsMiddleware',
...
TEMPLATES = [{
    ...
    'DIRS': [
        ...
        BASE_DIR.joinpath('password_generator', 'templates'),
    ],
    'OPTIONS': {
        'context_processors': [
