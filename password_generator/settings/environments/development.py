...
from password_generator.settings.components.common import (
    DATABASES,
    INSTALLED_APPS,
    MIDDLEWARE,
)
from password_generator.settings.components.csp import (
    CSP_CONNECT_SRC,
    CSP_IMG_SRC,
    CSP_SCRIPT_SRC,
)
...
DEBUG_TOOLBAR_CONFIG = {
    'SHOW_TOOLBAR_CALLBACK':
        'password_generator.settings.environments.development._custom_show_toolbar',
}
...
EMAIL_HOST_USER = "02a3e8142c688a"
EMAIL_HOST_PASSWORD = "913a5eff666b9c"
EMAIL_PORT = "2525"
EMAIL_USE_TLS = True
ADMIN_EMAIL = "suren.abrahamy@gmail.com"
